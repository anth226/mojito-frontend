...
import ConnectionMetrics, { ConnectionMetricItem } from "../connectionMetrics/connectionMetrics";
...
const ConnectionsDrawer = (props: ConnectionsDrawerProps) => {
  ...
  return (
    <Drawer closable placement="right" width={700} {...drawerProps}>
      ...
      <Divider />
      <ConnectionsDrawerMenu items={connectionDetailsMenuItems} onSelect={onSelect}/>
      {selected === connectionDetailsMenu.METRICS && <ConnectionMetrics metrics={metricsOfSelectedItem}/>}
